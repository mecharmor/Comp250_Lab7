...
<td align="left"><b>Edit Quantity</b></td>
</td>
';
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
	...
	<td align="left"><a href="edit_quantity.php?id=' . $row['prod_id'] . '">Edit</a></td>
</tr>
	</tr>
	';
}
...
echo '<a href="warehouse_front_page.php" type="button" class="btn btn-primary" >Back</a>';
echo '</div>';
?>
